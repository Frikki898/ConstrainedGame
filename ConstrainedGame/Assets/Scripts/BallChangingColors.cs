...
public class BallChangingColors : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ballMat.SetColor("_EmissionColor", new Color(1, 1, 0));
    }
    void Update()
    {
        ...
        if (currentTime > lightFluctateSpeed)
        {
            ...
            ballMat.SetColor("_EmissionColor", new Color((r / 255f), (g / 255f), (b / 255f)));
        }
    }
}
